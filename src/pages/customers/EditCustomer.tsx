...
const EditCustomer: React.FC = () => {
  ...
  useEffect(() => {
    const loadCustomer = async () => {
      ...
      try {
        ...
        const response = await apiService.getCustomer(parseInt(id));
        ...
        if (response.success && response.data) {
          ...
          const mappedLevel = levelMap[customerData.level] || customerData.level;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await apiService.updateCustomer(customer.id, submitData);
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-gray-700">Current Loyalty Points:</span>
                    <span className="text-lg font-semibold text-blue-600">{customer.loyalty_points} points</span>
                  </div>
                  <p className="text-xs text-gray-500 mt-1">Points are automatically earned from purchases</p>
                </div>
              </div>
            )}
